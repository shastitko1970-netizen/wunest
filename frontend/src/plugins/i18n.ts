...
const messages = {
  ru: {
    ...
    converter: {
      ...
      step2: {
        title: '2. Загрузи ST-тему',
        tagline: 'Файл .json, экспортированный из SillyTavern. Максимум {max}.',
        dropLabel: 'Перетащи .json сюда или кликни для выбора',
        dropHint: 'Максимум {max}',
      },
      convertButton: 'Конвертировать',
      costHint: 'Использует: {source}',
      errors: {
        tooLarge: 'Файл слишком большой. Максимум {max}.',
  ...
  en: {
    ...
    converter: {
      ...
      step2: {
        title: '2. Upload the ST theme',
        tagline: 'A .json file exported from SillyTavern. Max {max}.',
        dropLabel: 'Drop a .json here or click to pick',
        dropHint: 'Max {max}',
      },
