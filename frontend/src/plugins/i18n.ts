...
const messages = {
  ru: {
    ...
    chat: {
      ...
      authorsNote: {
        ...
        hint: 'Вставляется как system-сообщение на глубине Depth с конца истории.',
        depth: 'Глубина',
  ...
  en: {
    ...
    chat: {
      ...
      authorsNote: {
        label: "Author's Note",
        placeholder: 'Short note spliced into the middle of the dialogue…',
        hint: 'Injected as a system message at Depth turns from the end of history.',
        depth: 'Depth',
